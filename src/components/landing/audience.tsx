      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-12 sm:py-14 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.88fr)] lg:items-start lg:gap-14">
          ...
          <div className="flex flex-col">
            {/* The closing line is the argument in one sentence, so it stops being a
                fourth paragraph. It sits above the panel because it is the claim the
                panel then substantiates: read the sentence, then see the rules it is
                talking about. */}
            <p className="fx-reveal fx-reveal-2 mb-6 rounded-r-lg border-l-2 border-accent bg-surface-raised py-4 pl-5 pr-5 text-lg font-semibold leading-relaxed text-fg-primary">
              Practise until the rules feel boring. Then pay the fee.
            </p>

            <Panel
              className="fx-reveal fx-reveal-3"
              surface="raised"
              bar={
